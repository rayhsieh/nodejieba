...
nodejieba.load = function(dictJson) {
  ...
  var dict = dictJson.dict || nodejieba.DEFAULT_DICT;
  var hmmDict = dictJson.hmmDict || nodejieba.DEFAULT_HMM_DICT;
  var userDict = dictJson.userDict || nodejieba.DEFAULT_USER_DICT;
  var idfDict = dictJson.idfDict || nodejieba.DEFAULT_IDF_DICT;
  var stopWordDict = dictJson.stopWordDict || nodejieba.DEFAULT_STOP_WORD_DICT;
